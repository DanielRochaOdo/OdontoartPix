create or replace function public.request_member_reprocess_v3(
...
revoke all on function public.request_member_reprocess_v3(uuid, uuid) from public, anon, authenticated;
grant execute on function public.request_member_reprocess_v3(uuid, uuid) to service_role;
