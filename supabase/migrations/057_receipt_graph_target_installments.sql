-- O endpoint de historico completo retorna varias parcelas por associado.
-- O dashboard deve contabilizar apenas a parcela cadastrada no sistema para
-- cada vinculo, identificada por campaign_batch_members.target_installment_id.
...
as $$
  with grouped as (
    ...
    join public.member_installments mi
