create table if not exists public.processing_settings (
  ...
  processing_shutdown_reserve_ms integer not null default 9000,
  processing_persistence_reserve_ms integer not null default 5000,
  processing_finalization_reserve_ms integer not null default 8000,
