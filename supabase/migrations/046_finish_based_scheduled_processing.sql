-- Agendamento baseado no termino real da onda anterior.
-- O cron pode chamar esta funcao a cada minuto; a funcao decide atomica-
-- mente se uma nova onda pode ser criada.

alter table public.processing_settings
  drop constraint if exists processing_settings_scheduled_interval_minutes_check;
